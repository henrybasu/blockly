 ...
 * defining the rule for generating the collecttion, that jumps from one node to
 * the next.
 * @param {boolean=} includeThis true by default. If true, the returned
 * collection will contain this, otherwise it will not.
 * @return {Array<Blockly.ASTNode>} Stack containing the collection generated by
 ...
 */
Blockly.ASTNode.prototype.collect = function(advanceFn, includeThis=true) {
 ...
 * {@code this.collect(n => n.out(), includeThis)}.
 * @param {boolean=} includeThis false by default. If true, the returned stack
 * will contain this at the bottom, otherwise it will not.
 ...
 * @author macaccesslab@gmail.com (Logan Caraco in Macalester Lab)
 */
Blockly.ASTNode.prototype.ancestors = function(includeThis=false) {
  return this.collect(n => n.out(), includeThis);
};
 ...
 * @private
 */
Blockly.ASTNode.prototype.ascend = function() {
